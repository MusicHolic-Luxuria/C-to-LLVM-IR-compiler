...
for_stmt:
    FOR '(' assign_stmt ';'
    {
        TextCode.add("br label \%L" + (labelCount + 1));
...
argument returns [String str_arg]:
    a=arg
    {
        ...
        {
            $str_arg = "i8* getelementptr inbounds ([" + $a.num + " x i8], [" + $a.num + " x i8]* @.str" + strCount + ", i64 0, i64 0)";
            String temp = $a.text;
            temp = temp.substring(0, temp.length() - 1).concat("\\00\"");         
            temp = temp.replaceAll("\\\\n", "\\\\0A");    
            TextCode.add(0, "@.str" + strCount + " = private unnamed_addr constant [" + $a.num + " x i8] c" + temp + ", align 1");
            strCount++;
        }
    }
    (',' b=arg
    {
        ...
        else if ($b.theInfo.theType == Type.FLOAT)
        {
            ...
            varCount++;
            $str_arg = $str_arg + " , " + "double " + "\%t" + (varCount - 1);
        }
    }
    )*
;

arg returns [Info theInfo, int num] @init{$theInfo = new Info(); $num = 0;}:
    arith_expression
    {
    ...
    | STRING_LITERAL
    {
        ...
        $num = $num -2 + 1;
        if($STRING_LITERAL.text.contains("\\n"))
            $num = $num -1;
    }
;
...
cond_expression returns[Info theInfo] @init{$theInfo = new Info();}:
    ...
    (RelationOP b=arith_expression
    {
        ...
        if( 0 == temp)
        {
            ...
            {
                TextCode.add("\%t" + varCount + " = icmp slt float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.INT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ult float \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $b.theInfo.theVar.varIndex);
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ult float \%t" + $a.theInfo.theVar.varIndex + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ult float " + $a.theInfo.theVar.iValue + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ult float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
        ...
        if( 0 == temp)
        {
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ugt float \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ugt float \%t" + $a.theInfo.theVar.varIndex + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ugt float " + $a.theInfo.theVar.iValue + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ugt float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
        ...
        if( 0 == temp)
        {
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ule float \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ule float \%t" + $a.theInfo.theVar.varIndex + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ule float " + $a.theInfo.theVar.iValue + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ule float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
        ...
        if( 0 == temp)
        {
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp uge float \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp uge float \%t" + $a.theInfo.theVar.varIndex + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp uge float " + $a.theInfo.theVar.iValue + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp uge float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
        ...
        if( 0 == temp)
        {
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ueq float \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ueq float \%t" + $a.theInfo.theVar.varIndex + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ueq float " + $a.theInfo.theVar.iValue + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp ueq float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
        ...
        if( 0 == temp)
        {
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp une float \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp une float \%t" + $a.theInfo.theVar.varIndex + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp une float " + $a.theInfo.theVar.iValue + ", \%t" + $b.theInfo.theVar.varIndex);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
            ...
            {
                TextCode.add("\%t" + varCount + " = fcmp une float " + $a.theInfo.theVar.iValue + ", " + $b.theInfo.theVar.iValue);
                $theInfo.theType = Type.FLOAT;
                $theInfo.theVar.varIndex = varCount ;
                varCount++;
            }
...
arith_expression returns [Info theInfo] @init{theInfo = new Info();}:
    ...
    ( '+' b=multExpr
    {
        ...
        else if (($a.theInfo.theType == Type.CONST_FLOAT) && ($b.theInfo.theType == Type.FLOAT)) 
        {
            ...
            int temp = varCount;
            varCount++;
            TextCode.add("\%t" + varCount + " = fadd double \%t" + temp + ", " + $a.theInfo.theVar.fValue);
            temp = varCount;
            varCount ++;
            TextCode.add("\%t" + varCount + " = fptrunc double \%t" + temp + " to float");
    ...
    | '-' c=multExpr
    {
        ...
        else if (($a.theInfo.theType == Type.FLOAT) && ($c.theInfo.theType == Type.CONST_FLOAT)) 
        {
            ...
            int temp = varCount;
            varCount++;
            TextCode.add("\%t" + varCount + " = fsub double \%t" + temp + ", " + $b.theInfo.theVar.fValue);
            temp = varCount;
            varCount ++;
            TextCode.add("\%t" + varCount + " = fptrunc double \%t" + temp + " to float");
        ...
        else if (($a.theInfo.theType == Type.CONST_FLOAT) && ($c.theInfo.theType == Type.FLOAT)) 
        {
            ...
            int temp = varCount;
            varCount++;
            TextCode.add("\%t" + varCount + " = fsub double \%t" + temp + ", " + $a.theInfo.theVar.fValue);
            temp = varCount;
            varCount ++;
            TextCode.add("\%t" + varCount + " = fptrunc double \%t" + temp + " to float");
...
multExpr returns [Info theInfo] @init{theInfo = new Info();}:
    ...
    ( '*' b=signExpr
    {
        ...
        else if (($a.theInfo.theType == Type.CONST_FLOAT) && ($b.theInfo.theType == Type.FLOAT)) 
        {
            ...
            int temp = varCount;
            varCount++;
            TextCode.add("\%t" + varCount + " = fmul double \%t" + temp + ", " + $a.theInfo.theVar.fValue);
            temp = varCount;
            varCount ++;
            TextCode.add("\%t" + varCount + " = fptrunc double \%t" + temp + " to float");
    ...
    | '/' c=signExpr
    {
        ...
        if (($a.theInfo.theType == Type.INT) && ($c.theInfo.theType == Type.INT))
        {
            TextCode.add("\%t" + varCount + " = div i32 \%t" + $a.theInfo.theVar.varIndex + ", \%t" + $c.theInfo.theVar.varIndex);
        ...
        {
            TextCode.add("\%t" + varCount + " = div i32 \%t" + $a.theInfo.theVar.varIndex + ", " + $c.theInfo.theVar.iValue);
        ...
        {
            TextCode.add("\%t" + varCount + " = div i32 " + $a.theInfo.theVar.iValue + ", \%t" + $c.theInfo.theVar.varIndex);
        ...
        else if (($a.theInfo.theType == Type.FLOAT) && ($c.theInfo.theType == Type.CONST_FLOAT)) 
        {
            ...
            int temp = varCount;
            varCount++;
            TextCode.add("\%t" + varCount + " = fdiv double \%t" + temp + ", " + $b.theInfo.theVar.fValue);
            temp = varCount;
            varCount ++;
            TextCode.add("\%t" + varCount + " = fptrunc double \%t" + temp + " to float");
        ...
        else if (($a.theInfo.theType == Type.CONST_FLOAT) && ($c.theInfo.theType == Type.FLOAT)) 
        {
            ...
            int temp = varCount;
            varCount++;
            TextCode.add("\%t" + varCount + " = fdiv double \%t" + temp + ", " + $a.theInfo.theVar.fValue);
            temp = varCount;
            varCount ++;
            TextCode.add("\%t" + varCount + " = fptrunc double \%t" + temp + " to float");
...
signExpr returns [Info theInfo] @init{theInfo = new Info();}:
    ...
    | '-' b=primaryExpr
    {
        ...
        {
            $b.theInfo.theVar.iValue = -1 * $b.theInfo.theVar.iValue;
        }
        else if($b.theInfo.theType == Type.CONST_FLOAT)
        {
            $b.theInfo.theVar.fValue =  -1 * $b.theInfo.theVar.fValue;
        }
    }
;
